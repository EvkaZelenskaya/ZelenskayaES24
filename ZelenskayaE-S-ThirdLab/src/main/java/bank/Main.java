...
public class Main {
    public static void main(String[] args) {
        ...
        List<Bank> banks = Arrays.asList(
                ...
                bankService.createBank("ВТБ", 125, 150, 275, 36521),//1
                bankService.createBank("АльфаБанк", 125, 150, 275, 1453599)//2
        );

        List<BankOffice> bankOffices = Arrays.asList(
                bankOfficeService.createBankOffice(1, "Главный офис 1", "ул. Пушкина, д. 10, кв. 5", true, true, 45, false, true, true, 20, 45000, banks.get(0)),
                bankOfficeService.createBankOffice(2, "Главный офис 2", "ул. Маяковского, д. 10, кв. 5", true, true, 75, true, true, true, 3500, 33000, banks.get(1)),
        ...
        List<Employee> employees = Arrays.asList(
                employeeService.createEmployee(1, "Успехов Михаил", LocalDate.of(1985, 1, 15), "Менеджер", banks.get(0), true, bankOffices.get(0), true, 75000),
                employeeService.createEmployee(2, "Успехов Игорь", LocalDate.of(1985, 1, 15), "Менеджер", banks.get(1), true, bankOffices.get(1), true, 75000),
                employeeService.createEmployee(3, "Ольга Шеметова", LocalDate.of(2001, 8, 20), "Менеджер", banks.get(1), true, bankOffices.get(1), true, 35000),
                ...
                employeeService.createEmployee(5, "Классная Екатерина", LocalDate.of(1976, 5, 1), "Менеджер", banks.get(2), true, bankOffices.get(2), true, 50000)
        );

        List<User> users = Arrays.asList(
                userService.createUser(1, "Алиса Иванова", LocalDate.of(1990, 8, 8), "ул. Ленина, д. 15, кв. 31", banks.get(1)),
                userService.createUser(2, "Никита Кологривый", LocalDate.of(1993, 10, 5), "ул. Ленина, д. 15, кв. 3", banks.get(2)),
                userService.createUser(3, "Мария Петрова", LocalDate.of(1987, 12, 20), "ул. Пушкина, д. 5, кв. 10", banks.get(0))
        );
        ...
        List<BankAtm> bankAtms = Arrays.asList(
                bankAtmService.createBankAtm(1, "Банкомат приемлемый", "1", bankOffices.get(0), "ул. Красноармейская, д. 20", employees.get(0), true, true, 100, 10000),
                ...
                bankAtmService.createBankAtm(3, "Банкомат самый денежный", "1", bankOffices.get(2), "ул. Карасева, д. 20", employees.get(4), true, true, 100, 900000)
        );
