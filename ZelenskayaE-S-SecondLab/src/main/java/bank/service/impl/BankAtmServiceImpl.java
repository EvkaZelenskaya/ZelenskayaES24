...
public class BankAtmServiceImpl implements BankAtmService {
    ...
    @Override
    public BankAtm createBankAtm(int id, String name, String status, BankOffice bankOffice, String location, Employee servicingEmployee, boolean cashWithdrawal, boolean cashDeposit, boolean maintenance, double moneyAmount) {
