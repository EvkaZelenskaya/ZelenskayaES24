...
public class BankAtm {
     ...
     */
    public BankAtm(String name, String address, String status, Bank bank, BankOffice bankOffice, Employee serviceEmployee, boolean cashWithdrawal, boolean cashDeposit, double moneyAmount) {
